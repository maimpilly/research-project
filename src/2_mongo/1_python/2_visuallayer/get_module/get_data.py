...
## catalogue_get gets references from the DB filtred with my_dict
    def catalogue_get(self):
        ...
        statement1 = f"SELECT * FROM ias_shares.nfs_data  WHERE {filter} ALLOW FILTERING"
        statement2 = f"SELECT * FROM ias_shares.data_in_cloud WHERE {filter} ALLOW FILTERING"
